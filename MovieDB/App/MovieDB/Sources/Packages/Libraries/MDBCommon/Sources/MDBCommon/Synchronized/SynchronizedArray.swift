...
// basememara/SynchronizedArray.swift
// https://gist.github.com/basememara/afaae5310a6a6b97bdcdbe4c2fdcd0c6

/// A thread-safe array.
public class SynchronizedArray<Element> {
  private let queue = DispatchQueue(label: "com.SynchronizedArray", attributes: .concurrent)
...
public extension SynchronizedArray {
  ...
  func filter(_ isIncluded: @escaping (Element) -> Bool) -> SynchronizedArray {
    ...
    return result ?? SynchronizedArray([])
  }
  ...
  func reduce<ElementOfResult>(_ initialResult: ElementOfResult,
                               _ nextPartialResult: @escaping
                               (ElementOfResult, Element) -> ElementOfResult)
    -> ElementOfResult
  {
    var result: ElementOfResult?
  ...
  /// - Returns: The final accumulated value. If the sequence has no elements, the result is initialResult.
  func reduce<ElementOfResult>(into initialResult: ElementOfResult,
                               _ updateAccumulatingResult:
                               @escaping (inout ElementOfResult, Element) -> Void)
    -> ElementOfResult
  {
    var result: ElementOfResult?
